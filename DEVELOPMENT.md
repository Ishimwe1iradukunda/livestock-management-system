...
```bash
git remote add encore encore://livestock-management-system-xcsi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/livestock-management-system-xcsi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/livestock-management-system-xcsi/settings/integrations/github)
